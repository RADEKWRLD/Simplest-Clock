<template>
    <div class="main">
        <el-switch v-model="theme" inline-prompt style="--el-switch-on-color: #13ce66; --el-switch-off-color: #97a0ff"
            :active-icon="Sunny" :inactive-icon="Moon" @change="themeChange" />
        ...
        <a href="https://github.com/RADEKWRLD" target="_blank" class="github-icon">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="36" height="36">
                <path :fill="theme ? 'var(--theme-text-color)' : '#fff'" d="M12 0C5.372 0 0 5.372 0 12c0 5.298 3.438 9.799 8.205 11.387.6.111.826-.261.826-.579 0-.288-.011-1.05-.016-2.065-3.338.727-4.043-1.56-4.043-1.56-.544-1.381-1.33-1.749-1.33-1.749-1.088-.743.083-.728.083-.728 1.204.085 1.835 1.236 1.835 1.236 1.07 1.83 2.809 1.303 3.495.997.107-.776.418-1.303.76-1.604-2.665-.303-5.466-1.335-5.466-5.93 0-1.308.47-2.377 1.243-3.215-.124-.303-.537-1.527.116-3.181 0 0 1.007-.32 3.299 1.235.957-.266 1.978-.4 2.995-.405 1.017.005 2.038.14 2.995.405 2.292-1.554 3.298-1.235 3.298-1.235.654 1.654.24 2.878.116 3.181.773.838 1.243 1.907 1.243 3.215 0 4.605-2.801 5.624-5.475 5.923.429.371.81.965.81 1.951 0 1.408-.014 2.547-.014 2.898 0 .322.226.697.834.579C20.563 21.799 24 17.298 24 12c0-6.628-5.372-12-12-12z"/>
            </svg>
        </a>
    </div>
</template>
